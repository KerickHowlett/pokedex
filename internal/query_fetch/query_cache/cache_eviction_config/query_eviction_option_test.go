...
func TestWithNow(t *testing.T) {
	...
	t.Run("should set the Now field of the QueryEvictionConfig struct", func(t *testing.T) {
...
func TestWithTTL(t *testing.T) {
	...
	t.Run("should set the TTL field of the QueryEvictionConfig struct", func(t *testing.T) {
